...
# Insert to =======================================================
# =================================================================
  def insert_value(self, numberCell, value) -> bool:
    if numberCell < 1 or numberCell > 9:
        print("La case est hors de la grille")
        return False
    row = (numberCell - 1) // 3  # Ligne
    col = (numberCell - 1) % 3   # Colonne
...
# =================================================================
  ...
  def has_winner(self) -> bool:
    ...
    # Colonnes
    for row in range(2):
        if self._board[row][0] == last_player and self._board[row][1] == last_player and self._board[row][2] == last_player:
          return True
